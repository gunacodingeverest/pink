...
export const updateLocalVideo = (stream) => {
  ...
  localVideo.srcObject = stream; //local video update
...
export const showIncomingCallDialog = (
  ...
  // this code is for removing all dialogs inside HTML dialog element
...
// these are the ui helper functions
