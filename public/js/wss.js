...
export const registerSocketEvents = (socket) => {
  ...
  socket.on("connect", () => {
    console.log("succesfully connected to socket.io server"); // socket io connection
    store.setSocketId(socket.id);
    ui.updatePersonalCode(socket.id); //updating the personal code text box
  });
...
export const sendPreOffer = (data) => {
  console.log("emmiting to server pre offer event"); //emiting the data to the server
